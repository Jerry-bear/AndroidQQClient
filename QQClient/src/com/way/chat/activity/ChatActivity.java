...
public class ChatActivity extends MyActivity implements OnClickListener {
	...
	private void send() {
		...
		if (contString.length() > 0) {
			...
			RecentChatEntity entity1 = new RecentChatEntity(user.getId(), user.getImg(), 0, user.getName(), MyDate.getDate(), contString);
	...
	public void getMessage(TranObject msg) {
		...
		case MESSAGE:
			...
			ChatMsgEntity entity = new ChatMsgEntity(user.getName(), MyDate.getDateEN(), message, user.getImg(), true);// 收到的消息
