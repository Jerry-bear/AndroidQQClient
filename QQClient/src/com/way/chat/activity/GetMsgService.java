	...
	private Handler handler = new Handler() {
		public void handleMessage(Message msg) {
			...
			case MSG:
				...
				TranObject<TextMessage> textObject = (TranObject<TextMessage>) msg.getData().getSerializable("msg");
				...
				if (textObject != null) {
					...
					mNotification.setLatestEventInfo(mContext, util.getName() + " (" + newMsgNum + "条新消息)", content, contentIntent);
				}
